  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
        <div className='flex flex-col md:flex-row items-center justify-between w-full'>
            <Title align='left' title='Exclusive Offers' subTitle='Limited time offers for our most exclusive guests and partners with exclusive benefits. Be the first to know about our latest deals! Track your savings and exclusive perks with our loyalty program.' />
